                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  <h5> <?if (isset($err_msg)) {
                                   ...
                                   <form id="submit_form" class="form-horizontal" method="post" action="<? if(isset($edit)){echo site_url('admin/service/study_abroad_edit/'.$study_abroad->id);}else{echo site_url('admin/service/study_abroad_add');}?>">
                                        <fieldset>
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    ...
                                                    if (!isset($edit)) {
                                                      ...
                                                      ?>
                                                      <input class="focused" id="" type="text" name="name" value="<?echo $study_abroad->name;?>">
                                                      <?
                                                    }
                                                    ?>
                                                  </div>
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    ...
                                                    if (!isset($edit)) {
                                                      ...
                                                      ?>
                                                      <input class="focused datetimepicker" id="" type="text" name="date" value="<?echo $ci->m_time->unix_to_datetimepicker($study_abroad->date);?>">
                                                      <?
                                                    }
                                                    ?>
                                                  </div>
                                                ...
                                                if (isset($edit)) {
                                                  ...
                                                  <script type="text/javascript">
                                                    $("#country_id").val("<?=$study_abroad->country_id?>")
                                                  </script>
                                                  <?
                                                }
                                                ...
                                                <div class="span12 no-margin-left">
                                                  ...
                                                  <div class="controls">
                                                  <textarea class="focused" id="" type="checkbox" name="why" style="width: 450px;height: 200px;"><?if(isset($edit)){echo $study_abroad->why;}?></textarea>
                                                  </div>
                                                ...
                                                <div class="span12 no-margin-left">
                                                  ...
                                                  <div class="controls">
                                                  <textarea class="focused" id="" type="checkbox" name="location" style="width: 450px;height: 200px;"><?if(isset($edit)){echo $study_abroad->location;}?></textarea>
                                                  </div>
                                                </div>
                                                <div class="span12 no-margin-left">
                                                </div>
                                                <div class="span12 no-margin-left">
                                                  ...
                                                  <div class="controls">
                                                  <textarea class="focused" id="" type="checkbox" name="subject" style="width: 450px;height: 200px;"><?if(isset($edit)){echo $study_abroad->subject;}?></textarea>
                                                  </div>
                                                </div>
                                                <div class="span12 no-margin-left">
                                                </div>
                                                <div class="span12 no-margin-left" id="req">
                                                  <label class="control-label" for="focusedInput">เงื่อนไขการเข้าเรียน</label>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-success add_req">Add</button>
                                                    <?
                                                    if (isset($edit)) {
                                                      foreach ($study_abroad->req as $key => $value) {
                                                        ?>
                                                          <div class="req_p ">
                                                ...
                                                <div class="span12 no-margin-left">
                                                    ...
                                                    <?
                                                    if (isset($edit)) {
                                                      foreach ($study_abroad->img as $key => $value) {
                                                        ?>
                                                          <div class="img_hold">
                                                              <button dat-id="<?=$value->id?>" type="button" class="btn btn-danger del_con">Delete</button>
                                                              <img src="<?=site_url('media/study_abroad/'.$value->picture)?>" class="span12 file_tmp" >
