                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  <h5> <?if (isset($err_msg)) {
                                   ...
                                   <form id="submit_form" class="form-horizontal" method="post" action="<? if(isset($edit)){echo site_url('admin/gallery/gallery_edit/'.$gallery->id);}else{echo site_url('admin/gallery/gallery_add');}?>">
                                        <fieldset>           
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    ...
                                                    if (!isset($edit)) {
                                                      ?>
                                                      <input class="focused" id="" type="text" name="aname" value="">
                                                      <?
                                                    }else{
                                                      ?>
                                                      <input class="focused" id="" type="text" name="aname" value="<?echo $gallery->name;?>">
                                                      <?
                                                    }
                                                    ?>
                                                  </div>
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    ...
                                                    if (!isset($edit)) {
                                                      ...
                                                      ?>
                                                      <input class="focused datetimepicker" id="" type="text" name="date" value="<?echo $ci->m_time->unix_to_datetimepicker($gallery->date);?>">
                                                      <?
                                                    }
                                                    ?>
                                                  </div>
                                                ...
                                                <div class="span12 no-margin-left">
                                                  <h1 class="section_header blue_frame bg_left header_padding_left">Gallery</h1>
                                                  <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Select Photos</label>&nbsp;&nbsp;&nbsp;
                                                  ...
                                                  <div class="span12 no-margin-left">
                                                    ...
                                                    <?
                                                    if (isset($edit)) {
                                                      foreach ($gallery->img as $key => $value) {
                                                        ?>
                                                          <div class="img_hold">
                                                              <button dat-id="<?=$value->id?>" type="button" class="btn btn-danger del_con">Delete</button>
                                                              <img src="<?=site_url('media/gallery/'.$value->picture)?>" class="span12 file_tmp" >
                       ...
                       $('#progress .progress-bar').css(
                        ...
                        $.each(data.result.files, function (index, file) {
                            ...
                            if (file.error=="File is too big") {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: "<?php echo site_url('admin/gallery/ajax_add_ppl'); ?>",
                                    data: {
                                        "img_tmp": file.name,
                                    }
                                })
