                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Testimonial </div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                  <h5> <?if (isset($err_msg)) {
                                   ...
                                   <form id="submit_form" class="form-horizontal" method="post" action="<? echo site_url('admin/testimonial/');?>">
                                        <fieldset>                                          
                                                <div class="span12 no-margin-left">
                                                  <h1 class="section_header blue_frame bg_left header_padding_left">Testimonial</h1>
                                                    ...
                                                    foreach ($testimonial as $key => $value) {
                                                      ?>
                                                        <div class="img_hold">
                                                            ...
                                                            <img src="<?=site_url('media/testimonial/'.$value->picture)?>" class="span2 file_tmp" >
                       ...
                       $('#progress .progress-bar').css(
                        ...
                        $.each(data.result.files, function (index, file) {
                            ...
                            if (file.error=="File is too big") {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: "<?php echo site_url('admin/testimonial/ajax_add_ppl'); ?>",
                                    data: {
                                        "img_tmp": file.name,
                                    }
                                })
