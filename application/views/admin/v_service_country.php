                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  <h5> <?if (isset($err_msg)) {
                                   ...
                                   <form id="submit_form" class="form-horizontal" method="post" action="<? echo site_url('admin/service/country/');?>">
                                        <fieldset>                                          
                                                <div class="span12 no-margin-left">
                                                  <h1 class="section_header blue_frame bg_left header_padding_left">Country</h1>
                       ...
                       $('#progress .progress-bar').css(
                        ...
                        $.each(data.result.files, function (index, file) {
                            ...
                            if (file.error=="File is too big") {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: "<?php echo site_url('admin/service/ajax_add_country'); ?>",
                                    data: {
                                        "img_tmp": file.name,
                                    }
                                })
