                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit About </div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                  <h5> <?if (isset($err_msg)) {
                                   ...
                                   <form id="submit_form" class="form-horizontal" method="post" action="<? echo site_url('admin/about/');?>">
                                        <fieldset>                                          
                                                <div class="span12 no-margin-left">
                                                  <h1 class="section_header blue_frame bg_left header_padding_left">our team</h1>
                                                  <div class="control-group">
                                                    <label class="control-label" for="focusedInput" style="width:300px;">Main images (300x300 px)</label>&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    foreach ($our_team as $key => $value) {
                                                      ?>
                                                        <div class="img_hold">
                                                            ...
                                                            <img src="<?=site_url('media/our_team/'.$value->picture)?>" class="span12 file_tmp" >
                                                            ...
                                                            <input class="focused" id="" type="text" name="position[<?=$value->id?>]" value="<?=$value->position?>">                       
                                                        </div>
                                                      <?
                                                    }
                                                    ?>                                                 
                                                ...
                                                <div class="span12 no-margin-left">
                                                <h1 class="section_header blue_frame bg_left header_padding_left">FAQ</h1><button type="button" class="btn btn-success add_quest">Add</button>
                                                </div>
                                                <div class="faq_hold_parent span12 no-margin-left">
                                                  <?
                                                  foreach ($faq as $key => $value) {
                                                    ...
                                                    <div class="faq_hold no-margin-left">
                                                      ...
                                                      <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input class="focused" id="" type="text" name="question[]" value="<?=$value->question?>">
                                                        </div>
                                                      </div>
                                                      <label class="control-label" for="focusedInput">Answer</label>&nbsp;&nbsp;
                                                      <textarea class="focused" name="answer[]" style="width: 60%;height: 200px;"><?=$value->answer?></textarea>
                                                  </div>
                                                    <?
                                                  }
                                                  ?>
...
$( "#img_hold_parent" ).sortable({
  ...
  $(function() {
    ...
    $(document).on('click', ".add_quest", function() {
            $.ajax({
                                    method: "POST",
                                    url: "<?php echo site_url('admin/about/ajax_add_faq'); ?>",
                                    data: {
                                        "img_tmp": "",
                                    }
                                })
                                .done(function(data) {
                                    $(".faq_hold_parent").append(data);
                                });
        });
  });
                       ...
                       $('#progress .progress-bar').css(
                        ...
                        $.each(data.result.files, function (index, file) {
                            ...
                            if (file.error=="File is too big") {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: "<?php echo site_url('admin/about/ajax_add_ppl'); ?>",
                                    data: {
                                        "img_tmp": file.name,
                                    }
                                })
